...
namespace CH.Spartan.Tests
{
    public abstract class SpartanTestBase : AbpIntegratedTestBase
    {
        ...
        {
            using (var context = LocalIocManager.Resolve<SpartanDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<SpartanDbContext, T> func)
        {
            T result;
